...
public class gameDivision {
    ...
    private void iniciadatos() {
        preguntasSelected = Integer.valueOf(DivisionController.getPreguntasSelected().trim());
        rangoSelected = DivisionController.getRangoSelected();
        String s = DivisionController.geTiempoSelected().trim();
