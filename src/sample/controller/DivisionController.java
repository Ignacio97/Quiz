...
public class DivisionController {
    ...
    public void initialize() {
        ...
        rangocombobox.getItems().addAll("0-5", "0-10","0-100");
    ...
    private void playGame() {
        try {
            ...
            Parent root = FXMLLoader.load(getClass().getResource("/sample/vistas/gameDivision.fxml"));
            ...
            System.out.println("Algo salio mal cargando gameDivision!" + exception.getMessage());
