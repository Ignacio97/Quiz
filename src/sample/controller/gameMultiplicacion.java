...
public class gameMultiplicacion {
        ...
        private void iniciadatos() {
                preguntasSelected = Integer.valueOf(MultiplicationController.getPreguntasSelected().trim());
                rangoSelected = MultiplicationController.getRangoSelected();
                String s = MultiplicationController.geTiempoSelected().trim();
                alive=true;
                ...
                switch (rangoSelected) {
                        case "0-5":
                                maintittlelabel.setText("MULTIPLICACIÓN : 0-5");
                                quiz = new Quiz("preguntasmul0-5.txt", "respuestasmul0-5.txt");
                                break;
                        case "0-10":
                                maintittlelabel.setText("MULTIPLICACIÓN : 0-10");
                                quiz = new Quiz("preguntasmul0-10.txt", "respuestasmul0-10.txt");
                                break;
                        case "0-12":
                                maintittlelabel.setText("MULTIPLICACIÓN : 0-12");
                                quiz = new Quiz("preguntasmul0-12.txt", "respuestasmul0-12.txt");
                                break;
    ...
    private void goResults() {
        ...
        public static void setWrong(int wrong) {
                gameMultiplicacion.wrong = wrong;
        }
}
