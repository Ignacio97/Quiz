...
public class SubtractionController {
    ...
    public void initialize() {
        ...
        rangocombobox.getItems().addAll("0-5", "0-10", "0-20");
    ...
    public void goBackMenu(MouseEvent e) {
        ...
        try {
            ...
            System.out.println("Algo salio mal cargando el menu!" + exception.getMessage());
        } finally {
    ...
    private void playGame() {
        try {
            ...
            Parent root = FXMLLoader.load(getClass().getResource("/sample/vistas/gameResta.fxml"));
            Stage Stage = new Stage();
            Stage.setResizable(false);
            Stage.setTitle("hello world");
            Stage.setScene(new Scene(root, 1280, 768));
            ...
            System.out.println("Algo salio mal cargando playresta!" + exception.getMessage());
